...
# The following is the arch of rawnet3 which can be found here:
# https://github.com/Jungjee/RawNet/blob/master/python/RawNet3/models/RawNet3.py 
class RawNet3(nn.Module):
    def __init__(self, block, model_scale, context, summed, C=1024, **kwargs):
        ...
        #self.layer1 = block(C , C, kernel_size=3, dilation=2, scale=model_scale, pool=5)
        self.layer2 = block(
...
# The following 3 classes are basic blocks used for rawnet3 arch. which can be found in:
# https://github.com/Jungjee/RawNet/blob/master/python/RawNet3/models/RawNetBasicBlock.py
